// Modified from https://github.com/craftzdog/cm6-themes/blob/main/packages/basic-dark/src/index.ts
...
export const defaultDarkTheme = EditorView.theme(
  {
    "&": {
      color: base01,
...
export const defaultDarkHighlightStyle = HighlightStyle.define([
...
export const defaultDark: Extension = [
  defaultDarkTheme,
  syntaxHighlighting(defaultDarkHighlightStyle),
];
