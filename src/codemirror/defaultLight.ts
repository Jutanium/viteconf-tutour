// Modified from https://github.com/craftzdog/cm6-themes/blob/main/packages/basic-light/src/index.ts
...
export const defaultLightTheme = EditorView.theme(
  {
    "&": {
      color: base00,
...
export const defaultLightHighlightStyle = HighlightStyle.define([
